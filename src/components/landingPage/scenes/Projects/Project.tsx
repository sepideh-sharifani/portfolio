...
const Project = ({ name, image, link1, link2, description, TeckStack, image1, image2, image3, image4, }: Props) => {
    ...
    return (
        <div className="font-sans border border-gray-2 flex flex-col items-center justify-center gap-3 p-2">
            <div className=" flex flex-col gap-2">
                <img className='w-[300px] h-[200px] object-cover cursor-pointer'
                    src={image}
                    alt={`${image}`}
